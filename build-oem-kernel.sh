#!/bin/bash
# On 24.04
# sudo apt install curl debhelper-compat flex bison libssl-dev libelf-dev kernel-wedge pkg-config liblz4-tool tmux libncurses5-dev libcap-dev gawk gcc-13 dkms pahole cpio libdw-dev rustc rust-src bindgen bc
